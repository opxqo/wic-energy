...
/** A compact project link with a small, intentional hover acknowledgement. */
        ...
        <AnimatePresence mode="popLayout" initial={false}>
          {!isHovered ? (
            <motion.span
              key="github"
              initial={
                reducedMotion ? false : { y: -15, opacity: 0, scale: 0.8 }
              }
              animate={{ y: 0, opacity: 1, scale: 1 }}
              exit={
                reducedMotion ? undefined : { y: -15, opacity: 0, scale: 0.8 }
              }
              transition={spring}
